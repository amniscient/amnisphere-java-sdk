 ...
 */
package com.amniscient.api.resources.detection.types;
...
@JsonDeserialize(builder = DetectionDetectResponse.Builder.class)
public final class DetectionDetectResponse {
    ...
    private DetectionDetectResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DetectionDetectResponse && equalTo((DetectionDetectResponse) other);
    }
    ...
    private boolean equalTo(DetectionDetectResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(DetectionDetectResponse other) {
        ...
        public DetectionDetectResponse build() {
            return new DetectionDetectResponse(status, detections, additionalProperties);
        }
    }
}
