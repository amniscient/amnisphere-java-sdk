...
public class AmniscientApiApiException extends AmniscientException {
    ...
    public AmniscientApiApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public AmniscientApiApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
    ...
    public String toString() {
        return "AmniscientApiApiException{" + "message: " + getMessage() + ", statusCode: " + statusCode + ", body: "
                + body + "}";
    }
}
